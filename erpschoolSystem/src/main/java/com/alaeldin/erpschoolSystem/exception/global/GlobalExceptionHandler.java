package com.alaeldin.erpschoolSystem.exception.global;


import com.alaeldin.erpschoolSystem.exception.errordetails.ErrorDetails;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   /** @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<ErrorDetails> handleResourceRoleNotFound(ResourceNotFoundException exception,
                                                                   WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
                webRequest.getDescription(false), " Role Not Found");
        return new ResponseEntity<>(errorDetails, HttpStatus.NOT_FOUND);
    }**/
    ...
    public ResponseEntity<ErrorDetails> handleRoleAlreadyExist(RoleAlreadyExist exception, WebRequest webRequest) {
        ErrorDetails errorDetails = new ErrorDetails(LocalDateTime.now(), exception.getMessage(),
                webRequest.getDescription(false), "ROLE_ALREADY_EXISTS");
        return new ResponseEntity<>(errorDetails, HttpStatus.BAD_REQUEST);
    }
